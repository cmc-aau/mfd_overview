...
#setwd('/projects/microflora_danica/sub_projects/mfd_the_paper/analysis')

#metadata <- readxl::read_excel('data_overview/2024-02-06_mfd_db.xlsx') %>%
...
plot(rep(1, 13), col = soil.palette(13), pch = 19, cex = 3) # remeber to change if needed 12 <-> 13
...
# MFDO1 palette
mfdo1.palette <- c(sediment.palette(6), soil.palette(13), water.palette(6))
